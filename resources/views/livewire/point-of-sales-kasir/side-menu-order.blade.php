<div>
        ...
        <div class="sidebar-order-detail-content">
            ...
            <div class="ordered-detail">
                ...
                <div class="button-order-detail-group">
                    <button type="button" class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Simpan
                        Pesanan</button>
    ...
    {{-- <div x-data="{ openSidemenu: false }" x-show="openSidemenu" x-on:sidemenu-open.window ="openSidemenu = true"
        class="sidebar-order-detail" :class="openSidemenu ? 'isOpened' : ''"> --}}
    {{-- @if (request()->is('/pos/menu'))
        ...
        id="sidebar-trigger{{ $menuSaved['id'] }}">
                <div class="sidebar-order-detail-content">
                    <div class="order-detail-header d-flex flex-row justify-content-between align-items-center">
                        <h1 class="text-bold-20 color-f166">Rincian Pesanan</h1>
                        <a class="order-detail-close text-medium-20 color-7575" @click="openSidemenu = false">&times;</a>
                    </div>
                    <div class="button-order-detail-wrapper">
                        <button type="button" class="button-meja text-medium-12 color-c2c2" data-bs-toggle="modal"
                            data-bs-target="#modalPilihMeja">Meja</button>
        ...
        @else
            <div x-data="{ openSidemenu: false }" x-show="openSidemenu" x-on:sidemenu-open.window ="openSidemenu = true"
                ...
                <div class="sidebar-order-detail-content">
                    <div class="order-detail-header d-flex flex-row justify-content-between align-items-center">
                        <h1 class="text-bold-20 color-f166">Rincian Pesanan</h1>
                        <a class="order-detail-close text-medium-20 color-7575"
                            @click="openSidemenu = false">&times;</a>
                    </div>
                    <div class="button-order-detail-wrapper">
                        <button type="button" class="button-meja text-medium-12 color-c2c2" data-bs-toggle="modal"
                            data-bs-target="#modalPilihMeja">Meja</button>
                    ...
                    <div class="ordered-detail">
                        ...
                        <div class="ordered-wrapper">
                            <div class="ordered-menu-text">
                                <div class="menu-ordered">
                                    <p class="text-light-16 color-4040">1x Menu Name Here</p>
                                    <p class="text-light-12 color-7575">Variant, Size, Topping</p>
                                </div>
                            </div>
                            <div class="ordered-menu-number">
                        ...
                        <div class="button-order-detail-group">
                            <div class="button-cetak-bayar">
                                <button class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36"
                                    data-bs-toggle="modal" data-bs-target="#modalDiscVoucher">Diskon &
                                    Vocer</button>
                                <button class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Tambah
                                    Pesanan</button>
                            </div>
                            <div class="button-cetak-bayar">
                                <button type="button"
