<div>
    {!! request()->is('pos/menu')
        ? '<div id="sidebar-order" class="sidebar-order-detail">
                                                    ...
                                                    <div class="ordered-detail">
                                                        ...
                                                        <div class="button-order-detail-group">
                                                            ...
                                                            <div class="button-cetak-bayar">
                                                                ...
                                                                <button type="button"
                                                                    class="button-f166-inh text-medium-14 text-white p-8-16 h-36" 
                                                        ...
                                                        <div class="button-order-detail-group">
                                                            <div class="button-cetak-bayar">
                                                                <button class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36" data-bs-toggle="modal"
                                                                    ...
                                                                    Vocer</button>
                                                                <button class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Tambah Pesanan</button>
                                                            </div>
                                                            <div class="button-cetak-bayar">
                                                                <button type="button"
                                                                    class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Cetak</button>
