<div>
    {!! request()->is('pos/menu')
        ? '<div class="sidebar-order offcanvas offcanvas-end" tabindex="-1" id="sidebar-trigger">
                    <div class="sidebar-order-detail-content">
                        <div class="order-detail-header d-flex flex-row justify-content-between align-items-center">
                            ...
                            <a id="exit-shift-maincontent" class="order-detail-close text-medium-20 color-7575" data-bs-dismiss="offcanvas" onclick="closeSidebar()">&times;</a>
                        </div>
                            ...
                            <div class="ordered-wrapper">
                                <div class="ordered-menu-text">
                                    <div class="menu-ordered">
                                        <p class="text-light-16 color-4040">Menu Name</p>
        ...
        : (request()->is('pos/active-order')
            ? '<div class="sidebar-order offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                        id="sidebar-trigger">
                        <div class="sidebar-order-detail-content">
                            <div class="order-detail-header d-flex flex-row justify-content-between align-items-center">
                                <h1 class="text-bold-20 color-f166">Rincian Pesanan</h1>
                                <a class="order-detail-close text-medium-20 color-7575" data-bs-dismiss="offcanvas" onclick="closeSidebar()">&times;</a>
                            </div>
                            <div class="button-order-detail-wrapper">
                                <button type="button" class="button-meja text-medium-12 color-c2c2" data-bs-toggle="modal"
                                    data-bs-target="#modalPilihMeja">Meja</button>
                            ...
                            <div class="ordered-detail">
                                ...
                                <div class="button-order-detail-group">
                                    <div class="button-cetak-bayar">
                                        <button type="button" class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36"
                                        data-bs-toggle="modal" data-bs-target="#modalDiscVoucher">Diskon & Voucher</button>
                                        <button type="button"
                                        class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Tambah Pesanan</button>
                                    </div>
                                    <div class="button-cetak-bayar">
                                        <button type="button"
                                            class="button-outline-f166-inh text-medium-14 color-f166 p-8-16 h-36">Cetak</button>
